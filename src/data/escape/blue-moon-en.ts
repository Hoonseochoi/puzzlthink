...
export const blueMoonStoryEn: EscapeStory = {
  ...
  rooms: [
    { id: 'living', name: 'Living Room', isGathering: true, image: '/escape/blue-moon/room-living.png', background: 'linear-gradient(180deg, #2c1810 0%, #1a0f0a 100%)', floorPlanPosition: { left: 51, top: 69 } },
    { id: 'secretary', name: "Secretary Kim's Room", image: '/story/kimsecroom.png', background: 'linear-gradient(180deg, #1a2520 0%, #0d1512 100%)', floorPlanPosition: { left: 54, top: 30 } },
    { id: 'maid', name: 'Kitchen / Multi-purpose Room', image: '/story/steproom.png', background: 'linear-gradient(180deg, #1e1a25 0%, #100d15 100%)', floorPlanPosition: { left: 88, top: 50 } },
    { id: 'chairman_bedroom', name: "Chairman's Bedroom", image: '/story/chairmanroom.png', background: 'linear-gradient(180deg, #1a1a2e 0%, #0d0d1a 100%)', floorPlanPosition: { left: 37, top: 30 } },
    { id: 'chairman_bath', name: "Chairman's Bathroom", image: '/escape/blue-moon/room-chairman-bath.png', background: 'linear-gradient(180deg, #1a2525 0%, #0d1515 100%)', floorPlanPosition: { left: 68, top: 30 } },
    { id: 'son', name: "Son's Room", image: '/story/sonroom.png', background: 'linear-gradient(180deg, #2a1e1a 0%, #150f0d 100%)', floorPlanPosition: { left: 75, top: 64 } },
    { id: 'guest', name: 'Guest Room (Journalist)', image: '/story/leepoterroom.png', background: 'linear-gradient(180deg, #25201a 0%, #15100d 100%)', floorPlanPosition: { left: 15, top: 69 } },
    { id: 'lawyer_office', name: "Kim Lawyer's Office", image: '/story/kimlawerroom.png', background: 'linear-gradient(180deg, #1a1e2e 0%, #0d101a 100%)', floorPlanPosition: { left: 15, top: 47 } },
    { id: 'corridor', name: 'Corridor', image: '/story/lobby2f.png', background: 'linear-gradient(180deg, #1e1e28 0%, #12121a 100%)', floorPlanPosition: { left: 50, top: 47 }, floorPlanButtonSize: { minW: '120px', maxW: '140px', minH: '22px' }, floorPlanIcon: 'route' },
  ],
  ...
  clues: [
    ...
    { id: 'blue_crystal', name: 'Blue Crystal Vial', description: 'Evidence of a failed poisoning. The blue crystals at the bottom can be examined.', roomId: 'maid', chapter: 2, hotspotPosition: { left: 17, top: 88, width: 4.5, height: 14 }, dialogue: [{ characterId: 'maid', text: 'I… put it in his drink at 9. But the chairman didn’t drink it and threw it away. I failed.' }, { characterId: 'journalist', text: 'Mom… so the chairman didn’t die because of you?' }] },
    // Maid's room
    { id: 'maid_frame', name: 'Photo Frame', description: 'A young An the maid holding a girl who looks like her daughter. The photo is dated June 8, 1998. Where is the maid’s child now?', roomId: 'maid', chapter: 1, hotspotPosition: { left: 15, top: 55, width: 9, height: 11 }, dialogue: [{ characterId: 'junho', text: 'I was under the impression the maid was unmarried?' }, { characterId: 'kim_secretary', text: 'Hmm, whose child is that? I’ve never seen that child before.' }] },
    { id: 'maid_calendar', name: 'Calendar', description: 'February 22nd is circled. Why is this day so important...', roomId: 'maid', chapter: 1, hotspotPosition: { left: 84, top: 15, width: 15, height: 20 }, dialogue: [{ characterId: 'journalist', text: 'Could it be… a revenge she’s been waiting for? 30 years in the making!? What a scoop!' }, { characterId: 'kim_secretary', text: 'There’s more than one or two things that look suspicious.' }] },
    { id: 'locked_drawer', name: 'Locked Drawer', description: 'A locked drawer. It seems you need a key to open it.', roomId: 'maid', chapter: 1, hotspotPosition: { left: 18, top: 70, width: 10, height: 9 }, dialogue: [] },
    { id: 'hidden_diary', name: 'Hidden Diary', description: 'May 12, 2020. I learned of my daughter by chance after 22 years. I cannot break the "contract" with Chairman Choi… but if the contract were voided… we could live together…', roomId: 'maid', chapter: 1, hotspotPosition: { left: 29, top: 84, width: 11, height: 6 }, dialogue: [{ characterId: 'junho', text: 'What kind of contract did you have with my father? Is that child his daughter?' }, { characterId: 'kim_secretary', text: 'There were rumors of a child outside the family… but that it would be the maid’s daughter…' }] },
    ...
    { id: 'memory_card', name: 'Memory Card', description: 'Where is Kim Secretary going tonight...?', roomId: 'guest', chapter: 2, hotspotPosition: { left: 6, top: 73, width: 12, height: 10 }, dialogue: [{ characterId: 'journalist', text: 'This photo… I took it that night. The metadata says 23:35. The mansion clock said 12:05.' }, { characterId: 'kim_lawyer', text: '…Then the chairman’s time of death was 25 minutes before midnight. Before the will took effect.' }], imageOnClick: '/story/leephoto.png' },
    ...
    // Secretary Kim's room
    { id: 'slush_ledger', name: 'Slush Fund Ledger', description: 'A slush fund ledger. Monthly transfers of 10 million won to the maid (An). What is their relationship?', roomId: 'secretary', chapter: 1, hotspotPosition: { left: 17, top: 50, width: 6, height: 10 }, dialogue: [] },
    { id: 'ansistop', name: 'Ansistop', description: 'Hemorrhoids: improves vascular congestion around the anus to relieve pain and swelling. Hypertensive patients must use with caution—vasodilation can be dangerous.', roomId: 'secretary', chapter: 1, hotspotPosition: { left: 34, top: 66, width: 9, height: 4.5 }, dialogue: [] },
    { id: 'memo_books', name: 'Memo Between Books', description: '[<strong>Trees</strong> block the <strong>wind</strong> and the <strong>crescent moon</strong> lights up the <strong>mountain</strong>] ,,, What does this even mean?', roomId: 'secretary', chapter: 1, hotspotPosition: { left: 83, top: 38, width: 5, height: 14 }, dialogue: [] },
    { id: 'bug_device', name: 'Eavesdropping Device', description: 'Pressing the button, Junho\'s voice plays. "The will has to be kept here... What\'s the password? ...Click click. It won\'t open! The will must say how much I inherit—"', roomId: 'secretary', chapter: 1, hotspotPosition: { left: 83, top: 88, width: 5.5, height: 12 }, dialogue: [] },
    { id: 'locked_safe', name: 'Will B', description: 'Will: In the event of emergency, all assets of Chairman Choi shall be entrusted to the Blue Moon Foundation, and all disposition rights thereof shall vest in the Blue Moon Foundation. February 17, 2026, Chairman Choi', roomId: 'secretary', chapter: 1, hotspotPosition: { left: 48, top: 51, width: 14, height: 19 }, dialogue: [], passwordLock: { correctPassword: '1205' } },
    { id: 'famous_painting', name: 'Famous Painting', description: 'An elegant painting that looks like it was done by a famous artist. But something seems different from the one I know... I should look at it more closely.', roomId: 'secretary', chapter: 1, hotspotPosition: { left: 44, top: 20, width: 21, height: 24 }, dialogue: [], magnifierImage: '/story/pic_1205.png' },
    { id: 'magnifier', name: 'Magnifier', description: 'Used when you want to look at something in detail. Press the magnifier and click on a target to view it enlarged.', roomId: 'corridor', chapter: 1, hotspotPosition: { left: 23, top: 67, width: 6, height: 7.5 }, dialogue: [] },
  ],
